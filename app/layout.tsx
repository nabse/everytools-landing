...
export const metadata: Metadata = {
  ...
  description:
    "EveryTools is a suite of four AI browser extensions — multilingual and fully customizable. Reply to emails, summarize YouTube videos, explain any webpage, or decide if something is worth it — in your preferred language, at the level of detail you choose.",
  keywords: [
